...
from .pipeline.catalog import RELATION_EXTRACTION, CUSTOM_RELATION_EXTRACTION, Format
...
class CustomRelationExtractionDataset(Dataset):
    def __init__(self, reader: Reader, project: Project, **kwargs):
        super().__init__(reader, project, **kwargs)
        ...
        self.example_maker = ExampleMaker(
            ...
            data_class=TextData,
            column_data=kwargs.get("column_data") or DEFAULT_TEXT_COLUMN,
            exclude_columns=["cats", "entities", "relations"],
        )
...
def select_dataset(project: Project, task: str, file_format: Format) -> Type[Dataset]:
    mapping = {
        ...
        CUSTOM_RELATION_EXTRACTION: CustomRelationExtractionDataset,
        ...
        CUSTOM_DOCUMENT_CLASSIFICATION: CategoryAndSpanDataset,
    }

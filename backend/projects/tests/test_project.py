...
class TestArticleAnnotationProjectCreation(CRUDMixin):
    @classmethod
    def setUpTestData(cls):
        create_default_roles()
        cls.user = make_user()
        ...
        cls.data = {
            "name": "example",
            "project_type": "ArticleAnnotation",
            "description": "example",
            "guideline": "example",
            "allow_overlapping": True,
            "grapheme_mode": True,
            "resourcetype": "ArticleAnnotationProject",
        }
...
class TestAffectiveAnnotationProjectCreation(CRUDMixin):
    @classmethod
    def setUpTestData(cls):
        create_default_roles()
        cls.user = make_user()
        ...
        cls.data = {
            ...
            "allow_overlapping": True,
            "grapheme_mode": True,
            "resourcetype": "AffectiveAnnotationProject",
            "is_emotions_mode": True,
        }

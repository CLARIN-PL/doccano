    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('background_color', models.CharField(default=label_types.models.generate_random_hex_color, max_length=7)),
        ...
        migrations.AddConstraint(
            model_name='scaletype',
            constraint=models.UniqueConstraint(fields=('project', 'text'), name='label_types_scaletype_is_unique'),
        ),
    ]

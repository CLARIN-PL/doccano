...
from .views import (
    ...
    QuestionnaireFilledProgressListAPI,
)
...
urlpatterns = [
    ...
    path(route="questionnaire_states/<int:questionnaire_id>", view=QuestionnaireStateListAPI.as_view(), name="questionnaire_state_list"),
    path(route="questionnaire_filled_progress", view=QuestionnaireFilledProgressListAPI.as_view(), name="questionnaire_filled_progress_list"),
]

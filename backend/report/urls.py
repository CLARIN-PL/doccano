...
from .views import (
    ...
    UserDailyAvgActiveActiveMinutesAPI,
    AllUserDailyAvgActiveMinutesAPI,
    UserAvgSingleTextActiveMinutesAPI,
    AllUsersAvgSingleTextActiveMinutesAPI,
...
urlpatterns = [
    ...
    path(route="user-daily-avg-active-minutes/<int:user_id>/<date:startdate>/<date:enddate>/", view=UserDailyAvgActiveActiveMinutesAPI.as_view(), name="user_daily_active_time"),
    path(route="all-users-avg-active-minutes/<date:startdate>/<date:enddate>/", view=AllUserDailyAvgActiveMinutesAPI.as_view(), name="all_users_daily_active_time"),
    path(route="user-avg-single-text-active-minutes/<int:user_id>/<date:startdate>/<date:enddate>/", view=UserAvgSingleTextActiveMinutesAPI.as_view(), name="user_avg_single_text_active_annotation_time"),
    path(route="all-users-avg-single-text-active-minutes/<date:startdate>/<date:enddate>/", view=AllUsersAvgSingleTextActiveMinutesAPI.as_view(), name="all_users_avg_single_text_active_annotation_time"),

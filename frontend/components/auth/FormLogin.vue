...
export default Vue.extend({
  ...
  methods: {
    ...
    ...mapActions('user', ['setFirstLoginTime', 'setIsFirstLogin', 'checkQuestionnaire', 'setHasAnnotated','setHasAnnotatedToday']),
    setUserData() {
      try {
        ...
        this.setHasAnnotated(false)
        this.setHasAnnotatedToday(false)
